...
public class SignedRequestHmac {
     ...
     *
     * @param context
     * @see #precheck(SignedRequestPlayerClient)
     * @see #validate()
    ...
    public SignedRequestHmac(String userId, String secret, ClientRequestContext context) {
        this(userId,
             ...
             context.getMethod(), context.getUri().getPath());
    }
     ...
     */
    public void precheck(SignedRequestPlayerClient playerClient) throws WebApplicationException {
